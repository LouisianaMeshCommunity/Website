    ...
    <nav className="fixed top-0 left-0 w-full z-30 bg-gray-900 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto flex justify-between items-center px-4 py-3">
        ...
        <div className="hidden md:flex space-x-6 items-center text-white dark:text-gray-100 font-medium">
          ...
          <a href="/links" className="hover:text-indigo-300 transition">
            Links
          </a>
          <a
  ...
  const links = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 21h20L12 2zm0 14h.01M12 11V8" /></svg>
      )
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8" /></svg>
      )
    },
    {
      title: "Web Flasher",
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 20a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-3l-2 2h-3.5L10 22l-2-2H5z" /><path d="M12 11V6M12 18v-4" /></svg>
      )
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 10l4.5 4.5M15 10l-4.5 4.5M15 10l-4.5-4.5M15 10l4.5-4.5" /><path d="M21 12H3" /><path d="M21 12l-4.5 4.5" /><path d="M21 12l-4.5-4.5" /><path d="M3 12l4.5 4.5" /><path d="M3 12l4.5-4.5" /></svg>
      )
    },
  ];
